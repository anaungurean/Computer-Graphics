...
void Display3() {
    ...
    glVertex2f(0.5,  0.5); //cadran 1
    glVertex2f(-0.5, 0.5); //cadran 2
    glVertex2f(-0.5, -0.5); //cadran 3
    glVertex2f(0.5, -0.5); //cadran 4
